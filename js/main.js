...
function flipHiddenCard() {
  ...
  if (dealerHand.length === 2) {
    $('#dealer-card-1').removeClass('card-back').addClass('flipped');
    setTimeout(function () {
      $('#dealer-card-1')
        .attr('src', dealerHand[1].src)
        .attr('data-rank', dealerHand[1].label)
        .attr('data-suit-glyph', dealerHand[1].suitGlyph);
...
$('.reduce-aces-button').click(
  // Can only see this if player draws 2 aces, would only be reducing in 1st deck
  function () {
